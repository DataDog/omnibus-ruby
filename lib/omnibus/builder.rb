  ...
  class Builder
    ...
    def configure(*args)
      ...
      build_commands << BuildCommand.new("Copying config.h...") do
        candidates = ["config.h", File.join("include", "config.h"), "pyconfig.h", "libxml/xmlversion.h", File.join("build", "config.h"), File.join("include", "autoconf.h")]
        for c in candidates do
          config_h = File.join(software.project_dir, c)
          if File.exists? config_h
            log.info(log_key) { "Found #{config_h}"}
