...
module Omnibus
  class CLI < Command::Base
    ...
    def build(name)
      ...
      Omnibus::S3Cache.populate if Omnibus::Config.use_s3_caching && !Omnibus::S3Cache.fetch_missing.empty?
      Omnibus::S3LicenseCache.populate if Omnibus::Config.use_s3_caching
      project.download
      project.build
